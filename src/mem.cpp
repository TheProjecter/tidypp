...
#include "../include/tidypp/mem.hpp"
...
namespace tidypp
{
    namespace mem
    {
        ...
        {
            return tidySetFreeCall(ffree);
        }

        bool setmalloc(malloc fmalloc)
        {
            return tidySetMallocCall(fmalloc);
        }

        bool setpanic(panic fpanic)
        {
            return tidySetPanicCall(fpanic);
        }

        bool setrealloc(realloc frealloc)
        {
            return tidySetReallocCall(frealloc);
        }
    }
}
